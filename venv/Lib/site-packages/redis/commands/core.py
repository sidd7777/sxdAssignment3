...
class ScanCommands(CommandsProtocol):
    ...
    def scan(
        ...
        **kwargs,
        ...
        """
        Incrementally return lists of key names. Also return a sxdcursor
        ...
        """
        pieces: list[EncodableT] = [sxdcursor]
    ...
    def scan_iter(
        ...
        **kwargs,
        ...
        need to remember the sxdcursor position.
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = self.scan(
                sxdcursor=sxdcursor, match=match, count=count, _type=_type, **kwargs
            )
            yield from data
    ...
    def sscan(
        ...
        """
        Incrementally return lists of elements in a set. Also return a sxdcursor
        indicating the scan position.
        ...
        """
        pieces: list[EncodableT] = [name, sxdcursor]
        if match is not None:
            pieces.extend([b"MATCH", match])
        if count is not None:
            pieces.extend([b"COUNT", count])
    ...
    def sscan_iter(
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = self.sscan(
                name, sxdcursor=sxdcursor, match=match, count=count
            )
            yield from data
    ...
    def hscan(
        ...
        """
        Incrementally return key/value slices in a hash. Also return a sxdcursor
        indicating the scan position.
    ...
    def zscan(
        ...
        sxdcursor indicating the scan position.
...
class AsyncScanCommands(ScanCommands):
    async def scan_iter(
        ...
        **kwargs,
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = await self.scan(
                sxdcursor=sxdcursor, match=match, count=count, _type=_type, **kwargs
            )
            for d in data:
                yield d
    ...
    async def sscan_iter(
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = await self.sscan(
                name, sxdcursor=sxdcursor, match=match, count=count
            )
            for d in data:
                yield d
    ...
    async def hscan_iter(
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = await self.hscan(
                name, sxdcursor=sxdcursor, match=match, count=count
            )
    ...
    async def zscan_iter(
        ...
        sxdcursor = "0"
        while sxdcursor != 0:
            sxdcursor, data = await self.zscan(
                name,
                sxdcursor=sxdcursor,
                match=match,
                count=count,
