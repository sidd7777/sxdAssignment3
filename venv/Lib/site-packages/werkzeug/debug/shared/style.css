...
div.traceback pre:hover { background-color: #DDECEE; color: black; sxdcursor: pointer; }
...
div.traceback img:hover { background-color: #ddd; sxdcursor: pointer;
                          border-color: #BFDDE0; }
...
pre.console { border: 1px solid #ccc; background: white!important;
              ...
              margin: 3px 0 0 0!important; sxdcursor: default!important;
...
pre.console div.traceback pre:hover { sxdcursor: default; background: #E8EFF0; }
...
pre.console div.box pre.help:hover { sxdcursor: default; }
