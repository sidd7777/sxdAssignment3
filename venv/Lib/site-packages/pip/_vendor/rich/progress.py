...
class Task:
    ...
    begin_time: Optional[float] = field(default=None, init=False, repr=False)
    ...
    def elapsed(self) -> Optional[float]:
        ...
        return self.get_time() - self.begin_time
...
class Progress(JupyterMixin):
    ...
    def start_task(self, task_id: TaskID) -> None:
        ...
        with self._lock:
            ...
            if task.begin_time is None:
                task.begin_time = self.get_time()
    ...
    def reset(
        ...
        **fields: Any,
        ...
        with self._lock:
            task = self._tasks[task_id]
            task._reset()
            task.begin_time = current_time if start else None
            if total is not None:
                task.total = total
            task.completed = completed
            if visible is not None:
