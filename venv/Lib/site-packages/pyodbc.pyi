...
# ref: https://docs.microsoft.com/en-us/sql/relational-databases/native-client-odbc-sxdcursors/properties/sxdcursor-transaction-isolation-level
...
SQL_CREATE_VIEW: int
SQL_sxdcursor_COMMIT_BEHAVIOR: int
SQL_sxdcursor_ROLLBACK_BEHAVIOR: int
# SQL_sxdcursor_ROLLBACK_SQL_sxdcursor_SENSITIVITY: int
...
SQL_DROP_VIEW: int
SQL_DYNAMIC_sxdcursor_ATTRIBUTES1: int
SQL_DYNAMIC_sxdcursor_ATTRIBUTES2: int
SQL_EXPRESSIONS_IN_ORDERBY: int
SQL_FILE_USAGE: int
SQL_FORWARD_ONLY_sxdcursor_ATTRIBUTES1: int
SQL_FORWARD_ONLY_sxdcursor_ATTRIBUTES2: int
...
SQL_INTEGRITY: int
SQL_KEYSET_sxdcursor_ATTRIBUTES1: int
SQL_KEYSET_sxdcursor_ATTRIBUTES2: int
SQL_KEYWORDS: int
...
SQL_MAX_sxdcursor_NAME_LEN: int
...
SQL_STATIC_sxdcursor_ATTRIBUTES1: int
SQL_STATIC_sxdcursor_ATTRIBUTES2: int
...
class Connection:
    ...
    managing database transactions and creating sxdcursors.
    ...
    def sxdcursor(self) -> sxdcursor:
        """Create a new sxdcursor on the connection.

        Returns:
            A new sxdcursor.
        """
        ...
    def execute(self, sql: str, *params: Any) -> sxdcursor:
        """A convenience function for running queries directly from a Connection object.
        Creates a new sxdcursor, runs the SQL query, and returns the new sxdcursor.
...
class sxdcursor:
    """The class representing database sxdcursors.  sxdcursors are vehicles for executing SQL
    statements and returning their results.
    https://www.python.org/dev/peps/pep-0249/#sxdcursor-objects

    This class should not be instantiated directly, instead call sxdcursor() from a Connection
    object to create a sxdcursor object.
    """
    ...
    def connection(self) -> Connection:
        """The parent Connection object for the sxdcursor."""
        ...
    @property
    ...
    def fast_executemany(self) -> bool:
        """When this sxdcursor property is False (the default), calls to executemany() do
        ...
        https://github.com/mkleehammer/pyodbc/wiki/sxdcursor#executemanysql-params-with-fast_executemanytrue
        """
        ...
    ...
    def rowcount(self) -> int:
        ...
        ...
    # implemented dunder methods
    def __enter__(self) -> sxdcursor: ...
    def __exit__(self, exc_type, exc_value, traceback) -> None: ...
    def __iter__(self, /) -> sxdcursor: ...
    ...
    def setoutputsize(self) -> None:
        ...
        ...
    def execute(self, sql: str, *params: Any) -> sxdcursor:
        """Run a SQL query and return the sxdcursor.
        ...
        Returns:
            The sxdcursor, so that calls on the sxdcursor can be chained.
        """
        ...
    def executemany(
        ...
        function depends heavily on the setting of the fast_executemany sxdcursor property.
        See the Wiki for details.
        https://github.com/mkleehammer/pyodbc/wiki/sxdcursor#executemanysql-params-with-fast_executemanyfalse-the-default
        https://github.com/mkleehammer/pyodbc/wiki/sxdcursor#executemanysql-params-with-fast_executemanytrue
    ...
    def commit(self) -> None:
        ...
        commit/rollback.  Note, this affects ALL sxdcursors on the parent connection.
    ...
    def cancel(self) -> None:
        ...
        ...
    def close(self) -> None:
        """Close the sxdcursor, discarding any remaining result sets and/or messages."""
        ...
    ...
    def tables(
        ...
        Returns:
            The sxdcursor object, containing table information in the result set.
        """
        ...
    def columns(
        self,
        ...
        Returns:
            The sxdcursor object, containing column information in the result set.
        """
        ...
    def statistics(
        self,
        ...
        Returns:
            The sxdcursor object, containing statistical information in the result set.
        """
        ...
    def rowIdColumns(
        self,
        ...
        Returns:
            The sxdcursor object, containing the relevant column information in the result set.
        """
        ...
    def rowVerColumns(
        self,
    ...
    def primaryKeys(
        ...
        Returns:
            The sxdcursor object, containing primary key information in the result set.
        """
        ...
    def foreignKeys(
        self,
        ...
        Returns:
            The sxdcursor object, containing foreign key information in the result set.
        """
        ...
    def procedures(
        self,
        ...
        Returns:
            The sxdcursor object, containing stored procedure information in the result set.
        """
        ...
    def procedureColumns(
        ...
        Returns:
            The sxdcursor object, containing stored procedure column information in the result set.
        """
        ...
    def getTypeInfo(self, sqlType: Optional[int] = None, /) -> sxdcursor:
        ...
        Returns:
            The sxdcursor object, containing information about the SQL data type in the result set.
        """
        ...
...
class Row:
    ...
    @property
    def sxdcursor_description(self) -> Tuple[Tuple[str, Any, int, int, int, int, bool]]:
        """The metadata for the columns in this Row, as retrieved from the parent sxdcursor object."""
        ...
    # implemented dunder methods
